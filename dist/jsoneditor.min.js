...
// Simple types
// Simple types
return"string"==typeof a?"string"===a?"string"==typeof b:"number"===a?"number"==typeof b:"integer"===a?"number"==typeof b&&b===Math.floor(b):"boolean"===a?"boolean"==typeof b:"array"===a?Array.isArray(b):"object"===a?null!==b&&!Array.isArray(b)&&"object"==typeof b:"null"===a?null===b:!0:!this._validateSchema(a,b).length}}),f.LayoutBuilder=a.extend({init:function(a){this.options=a,this._rootContainer=this.options.theme.getContainer()},getLayoutHolderForEditor:function(a){if(this.options.layout_schema){var b;return d(this.options.layout_schema.groups,function(c,e){var f=!1;return e.Fields&&(d(e.Fields,function(c,d){return d.Path==a.path?(f=!0,b=e,!1):void 0}),f)?!1:void(e.OtherFields&&a.parent&&"root"==a.parent.key&&(b=e))}),b?b.container:void 0}},buildLayout:function(){var a=this;d(this.options.layout_schema.layout,function(b,c){a._buildBlock(c,a._rootContainer)})},_buildBlock:function(a,b){var c=this,e=this._constructBlockContainer(a);if(d(a.childBlocks,function(a,b){c._buildBlock(b,e)}),"group"==a.type){var f=this._findGroup(a.RefId);f.container=e,f.container.setAttribute("id",f.Id)}b.appendChild(e)},_constructBlockContainer:function(a){if(f.LayoutBuilder.blocks[a.type]){var b=new f.LayoutBuilder.blocks[a.type](this.options),c=b.createContainer(a);if(a.title){var e=document.createElement("span");e.textContent=a.title;var g=this.options.theme.getHeader(e);g.setAttribute("class","layout-block-title"),c.appendChild(g)}return a.attributes&&d(a.attributes,function(a,b){c.setAttribute(b.name,b.value)}),c}},_findGroup:function(a){var b=!1;if(d(this.options.layout_schema.groups,function(c,d){return d.Id==a?(b=d,!1):void 0}),!b)throw"Invalid layout schema. Unable to find group with id="+a;return b}}),f.LayoutBuilder.blocks={},f.LayoutBuilder.blocks.separator=a.extend({init:function(a){this.options=a},createContainer:function(){var a=document.createElement("div");return a.setAttribute("style","display:block; clear: both;"),a}}),f.LayoutBuilder.blocks.group=a.extend({init:function(a){this.options=a},createContainer:function(){var a=this.options.theme.getIndentedPanel();return a}}),f.LayoutBuilder.blocks.container=a.extend({init:function(a){this.options=a},createContainer:function(){var a=this.options.theme.getIndentedPanel();return a}}),/**
