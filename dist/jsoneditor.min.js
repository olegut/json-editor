...
constructor:f,init:function(){var a=this;this.ready=!1;var b=f.defaults.themes[this.options.theme||f.defaults.theme];if(!b)throw"Unknown theme "+(this.options.theme||f.defaults.theme);this.schema=this.options.schema,this.layout_schema=this.options.layout_schema,this.theme=new b,this.template=this.options.template,this.refs=this.options.refs||{},this.uuid=0,this.__data={};var c=f.defaults.iconlibs[this.options.iconlib||f.defaults.iconlib];c&&(this.iconlib=new c),this.root_container=this.theme.getContainer(),this.layout_builder=new f.LayoutBuilder({theme:this.theme,layout_schema:this.layout_schema,root_container:this.root_container}),this.root_container=this.theme.getContainer(),void 0!==this.layout_schema&&(this.layout_container=this.layout_builder._rootContainer,this.root_container.appendChild(this.layout_container)),this.element.appendChild(this.root_container),this.translate=this.options.translate||f.defaults.translate,
...
// Simple types
// Simple types
return"string"==typeof a?"string"===a?"string"==typeof b:"number"===a?"number"==typeof b:"integer"===a?"number"==typeof b&&b===Math.floor(b):"boolean"===a?"boolean"==typeof b:"array"===a?Array.isArray(b):"object"===a?null!==b&&!Array.isArray(b)&&"object"==typeof b:"null"===a?null===b:!0:!this._validateSchema(a,b).length}}),f.LayoutBuilder=a.extend({init:function(a){this.options=a,this._rootContainer=this.options.theme.getContainer()},getGroupForEditor:function(a){if(this.options.layout_schema){var b;return d(this.options.layout_schema.groups,function(c,e){var f=!1;return e.Fields&&(d(e.Fields,function(c,d){return d.Path==a.path?(f=!0,b=e,!1):void 0}),f)?!1:void(e.OtherFields&&a.parent&&"root"==a.parent.key&&(b=e))}),b?b:void 0}},buildLayout:function(){var a=this;d(this.options.layout_schema.layout,function(b,c){a._buildBlock(c,a._rootContainer)})},_buildBlock:function(a,b){var c=this,e=this._constructBlockContainer(a);if(d(a.childBlocks,function(a,b){c._buildBlock(b,e.editor_holders)}),"group"==a.type){var f=this._findGroup(a.RefId);f.container=e,f.block=a,f.container.root.setAttribute("id",f.Id)}b.appendChild(e.root)},_constructBlockContainer:function(a){if(f.LayoutBuilder.blocks[a.type]){a.builder=new f.LayoutBuilder.blocks[a.type](this.options,a);var b=a.builder.buildContainer();if(a.title){var c=document.createElement("span");c.textContent=a.title;var e=this.options.theme.getHeader(c);e.setAttribute("class","layout-block-title"),b.root.appendChild(e)}return a.attributes&&d(a.attributes,function(a,c){b.root.setAttribute(c.name,c.value)}),b}},_findGroup:function(a){var b=!1;if(d(this.options.layout_schema.groups,function(c,d){return d.Id==a?(b=d,!1):void 0}),!b)throw"Invalid layout schema. Unable to find group with id="+a;return b}}),f.LayoutBuilder.AbstractBlock=a.extend({init:function(a,b){this.options=a,this.block=b},buildEditorHolder:function(){return this.options.theme.getGridColumn()}}),f.LayoutBuilder.blocks={},f.LayoutBuilder.blocks.separator=f.LayoutBuilder.AbstractBlock.extend({buildContainer:function(){var a=document.createElement("div");a.setAttribute("style","display:block; clear: both;");var b={};return b.editor_holders=a,b.root=a,b}}),f.LayoutBuilder.blocks.group=f.LayoutBuilder.AbstractBlock.extend({buildContainer:function(){var a={};return"tabs"==this.block.renderAs?(a.root=this.options.theme.getTabHolder(),a.editor_holders=this.options.theme.getTabContentHolder(a.root)):(a.editor_holders=this.options.theme.getIndentedPanel(),a.root=a.editor_holders),a},buildEditorHolder:function(){return"tabs"==this.block.renderAs?this.options.theme.getTab(document.createElement("span")):this._super()}}),f.LayoutBuilder.blocks.container=f.LayoutBuilder.AbstractBlock.extend({buildContainer:function(){var a={};return a.editor_holders=this.options.theme.getIndentedPanel(),a.root=a.editor_holders,a}}),/**
...
this.error_holder=document.createElement("div"),this.container.appendChild(this.error_holder),b?"root"==a.key?(this.layout_holder=this.jsoneditor.layout_container,this.editor_holder=this.jsoneditor.layout_container):(this.layout_holder=a.jsoneditor.layout_builder.getLayoutHolderForEditor(a),this.layout_holder||(this.layout_holder=this.container),this.editor_holder=this.theme.getIndentedPanel(),this.row_container=this.theme.getGridContainer(),this.editor_holder.appendChild(this.row_container),this.layout_holder.appendChild(this.editor_holder)):(this.editor_holder=this.theme.getIndentedPanel(),this.container.appendChild(this.editor_holder),this.row_container=this.theme.getGridContainer(),this.editor_holder.appendChild(this.row_container)),d(this.editors,function(c,d){var e=a.jsoneditor.layout_builder.getGroupForEditor(d);if(b&&e&&e.container.editor_holders){var f=e.block.builder.createEditorHolder();a.options.table_row&&(e.container.editor_holders=a.container,f=a.theme.getTableCell()),e.container.editor_holders.appendChild(f),d.setContainer(f)}else{var g=a.theme.getGridColumn();a.row_container.appendChild(g),d.setContainer(g)}d.build(),d.postBuild()}),
// Control buttons
