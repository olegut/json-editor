...
return a=function(){},a.extend=function(a){function d(){!b&&this.init&&this.init.apply(this,arguments)}var e=this.prototype;b=!0;var f=new this;b=!1;for(var g in a)f[g]="function"==typeof a[g]&&"function"==typeof e[g]&&c.test(a[g])?function(a,b){return function(){var c=this._super;this._super=e[a];var d=b.apply(this,arguments);return this._super=c,d}}(g,a[g]):a[g];return d.prototype=f,d.prototype.constructor=d,d.extend=arguments.callee,d},a}(),
...
constructor:f,init:function(){var a=this;this.ready=!1;var b=f.defaults.themes[this.options.theme||f.defaults.theme];if(!b)throw"Unknown theme "+(this.options.theme||f.defaults.theme);this.schema=this.options.schema,this.layout_schema=this.options.layout_schema,this.theme=new b,this.template=this.options.template,this.refs=this.options.refs||{},this.uuid=0,this.__data={};var c=f.defaults.iconlibs[this.options.iconlib||f.defaults.iconlib];c&&(this.iconlib=new c),this.root_container=this.theme.getContainer(),this.layout_container=this.theme.getContainer(),this.layout_builder=new f.RootLayoutBuilder({theme:this.theme,layout_schema:this.layout_schema,root_container:this.layout_container}),void 0!==this.layout_schema&&this.root_container.appendChild(this.layout_container),this.element.appendChild(this.root_container),this.translate=this.options.translate||f.defaults.translate,
...
var c=a.getEditorClass(a.schema);a.root=a.createEditor(c,{jsoneditor:a,schema:a.schema,required:!0,container:a.root_container}),a.layout_builder.options.layout_schema&&a.layout_builder.buildLayout(),a.root.preBuild(),a.root.build(),a.root.postBuild(),
// Starting data
...
// Simple types
// Simple types
return"string"==typeof a?"string"===a?"string"==typeof b:"number"===a?"number"==typeof b:"integer"===a?"number"==typeof b&&b===Math.floor(b):"boolean"===a?"boolean"==typeof b:"array"===a?Array.isArray(b):"object"===a?null!==b&&!Array.isArray(b)&&"object"==typeof b:"null"===a?null===b:!0:!this._validateSchema(a,b).length}}),f.LayoutBuilder={},f.LayoutBuilder.AbstractLayoutBuilder=a.extend({init:function(a,b,c){this.options=a,this.block=b,this.block&&(this.block.builder=this),this.parentBlock=c,this.container={}},buildContainer:function(){if(this.block.title&&!this.ignoreTitle){var a=document.createElement("span");a.textContent=this.block.title;var b=this.options.theme.getHeader(a);b.setAttribute("class","layout-block-title"),this.container.root.appendChild(b)}},afterBuildContainer:function(){var a=this;this.block.attributes&&d(this.block.attributes,function(b,c){a.container.root.setAttribute(c.name,c.value)}),this.block.cssClass&&"string"==typeof this.block.cssClass&&a.container.root.classList.add(this.block.cssClass),this.block.cssClass&&"[object Array]"===Object.prototype.toString.call(this.block.cssClass)&&d(this.block.cssClass,function(b,c){a.container.root.classList.add(c)})},buildEditorHolder:function(a){return this.options.theme.getGridColumn()},attachChildBlock:function(a){this.container.root.appendChild(a.container.root)},getGroupForEditor:function(a){if(this.options.layout_schema){var b;return d(this.options.layout_schema.groups,function(c,e){var f=!1;return e.Fields&&(d(e.Fields,function(c,d){return d.Path==a.path?(f=!0,b=e,!1):void 0}),f)?!1:void(e.OtherFields&&a.parent&&"root"==a.parent.key&&(b=e))}),b?(a.group=b,b):void 0}},_buildBlock:function(){var a=this;this.block.container=this.buildContainer(),this.afterBuildContainer(),d(this.block.childBlocks,function(b,c){var d=new f.LayoutBuilder.builders[c.type](a.options,c,a.block);d._buildBlock()}),this.parentBlock&&this.parentBlock.builder.attachChildBlock?this.parentBlock.builder.attachChildBlock(this.block):a.options.root_container.appendChild(this.block.container.root)},_findGroup:function(a){var b=!1;if(d(this.options.layout_schema.groups,function(c,d){return d.Id==a?(b=d,!1):void 0}),!b)throw"Invalid layout schema. Unable to find group with id="+a;return b}}),f.RootLayoutBuilder=f.LayoutBuilder.AbstractLayoutBuilder.extend({init:function(a){this._super(a)},buildLayout:function(){var a=this;d(this.options.layout_schema.layout,function(b,c){var d=new f.LayoutBuilder.builders[c.type](a.options,c);d._buildBlock()})}}),f.LayoutBuilder.builders={},f.LayoutBuilder.builders.separator=f.LayoutBuilder.AbstractLayoutBuilder.extend({buildContainer:function(){var a=document.createElement("div");a.setAttribute("style","display:block; clear: both;");var b={};return b.editor_holders=a,b.root=a,this._super(),b}}),f.LayoutBuilder.builders.group=f.LayoutBuilder.AbstractLayoutBuilder.extend({buildContainer:function(){return this.container.editor_holders=this.options.theme.getIndentedPanel(),this.container.root=this.container.editor_holders,this._super(),this.container},_buildBlock:function(){this._super();var a=this._findGroup(this.block.RefId);a.container=this.container,a.builder=this,a.container.root.setAttribute("id",a.Id)}}),f.LayoutBuilder.builders.container=f.LayoutBuilder.AbstractLayoutBuilder.extend({buildContainer:function(){return this.container.editor_holders=this.options.theme.getIndentedPanel(),this.container.root=this.container.editor_holders,this._super(),this.container}}),f.LayoutBuilder.builders.tab_container=f.LayoutBuilder.AbstractLayoutBuilder.extend({init:function(a,b,c){this.active_tab=null,this.tabs=[],this._super(a,b,c)},buildContainer:function(){// tab holder
return this.container.root=this.options.theme.getIndentedPanel(),this.tab_holder=this.options.theme.getTabHolder(),this.container.root.appendChild(this.tab_holder),this.container.editor_holders=this.tab_holder,this.container.tab_content_holder=this.options.theme.getTabContentHolder(this.tab_holder),this._super(),this.container},attachChildBlock:function(a){this.container.tab_content_holder.appendChild(a.container.root)},registerTab:function(a,b){var c=this;this.options.theme.addTab(this.tab_holder,a),a.addEventListener("click",function(b){c.active_tab=a,c.refreshTabs(),b.preventDefault(),b.stopPropagation()}),this.tabs.push({tab:a,tabContent:b}),this.active_tab||(this.active_tab=a),this.refreshTabs()},refreshTabs:function(){var a=this;d(this.tabs,function(b,c){c.tab===a.active_tab?(a.options.theme.markTabActive(c.tab),c.tabContent.style.display=""):(a.options.theme.markTabInactive(c.tab),c.tabContent.style.display="none")})}}),f.LayoutBuilder.builders.tab=f.LayoutBuilder.builders.group.extend({init:function(a,b,c){this.ignoreTitle=!0,this._super(a,b,c)},buildContainer:function(){var a=document.createElement("span");return a.style.cursor="pointer",a.textContent=this.block.title,this.tab=this.options.theme.getTab(a),this.container.root=this.options.theme.getTabContent(),this.container.editor_holders=this.container.root,this.parentBlock.builder.registerTab(this.tab,this.container.root),this.container}}),/**
...
//editor: editor,
width:g,height:h}),f[e].width+=g,f[e].minh=Math.min(f[e].minh,h),f[e].maxh=Math.max(f[e].maxh,h)}}),a=0;a<f.length;a++)if(f[a].width<12){var g=!1,h=0;for(b=0;b<f[a].editors.length;b++)g===!1?g=b:f[a].editors[b].width>f[a].editors[g].width&&(g=b),f[a].editors[b].width*=12/f[a].width,f[a].editors[b].width=Math.floor(f[a].editors[b].width),h+=f[a].editors[b].width;12>h&&(f[a].editors[g].width+=12-h),f[a].width=12}
// layout hasn't changed
if(this.layout===JSON.stringify(f))return!1;for(this.layout=JSON.stringify(f),e=document.createElement("div"),a=0;a<f.length;a++){var i=this.theme.getGridRow();for(e.appendChild(i),b=0;b<f[a].editors.length;b++){var j=f[a].editors[b].key,k=this.editors[j];k.options.hidden?k.container.style.display="none":this.theme.setGridColumnSize(k.container,f[a].editors[b].width),i.appendChild(k.container)}}}else e=document.createElement("div"),d(this.property_order,function(a,b){var d=c.editors[b];if(!d.property_removed){var f=c.theme.getGridRow();e.appendChild(f),d.options.hidden?d.container.style.display="none":c.theme.setGridColumnSize(d.container,12),f.appendChild(d.container)}});this.row_container.innerHTML="",this.row_container.appendChild(e)}},getPropertySchema:function(a){
...
return!d&&this.schema.additionalProperties&&"object"==typeof this.schema.additionalProperties&&(b=c({},this.schema.additionalProperties)),b},preBuild:function(){this._super(),this.editors={},this.cached_editors={};var a=this;if(this.format=this.options.layout||this.options.object_layout||this.schema.format||this.jsoneditor.options.object_layout||"normal",this.schema.properties=this.schema.properties||{},this.minwidth=0,this.maxwidth=0,this.options.table_row)d(this.schema.properties,function(b,c){var d=a.jsoneditor.getEditorClass(c);a.editors[b]=a.jsoneditor.createEditor(d,{jsoneditor:a.jsoneditor,schema:c,path:a.path+"."+b,parent:a,compact:!0,required:!0}),a.editors[b].preBuild();var e=a.editors[b].options.hidden?0:a.editors[b].options.grid_columns||a.editors[b].getNumColumns();a.minwidth+=e,a.maxwidth+=e}),this.no_link_holder=!0;else{if(this.options.table)
// TODO: table display format
throw"Not supported yet";this.defaultProperties=this.schema.defaultProperties||Object.keys(this.schema.properties),
// Increase the grid width to account for padding
a.maxwidth+=1,d(this.defaultProperties,function(b,c){a.addObjectProperty(c,!0),a.editors[c]&&(a.minwidth=Math.max(a.minwidth,a.editors[c].options.grid_columns||a.editors[c].getNumColumns()),a.maxwidth+=a.editors[c].options.grid_columns||a.editors[c].getNumColumns())})}
// Sort editors by propertyOrder
this.property_order=Object.keys(this.editors),this.property_order=this.property_order.sort(function(b,c){var d=a.editors[b].schema.propertyOrder,e=a.editors[c].schema.propertyOrder;return"number"!=typeof d&&(d=1e3),"number"!=typeof e&&(e=1e3),d-e})},build:function(){var a=this;if(this.options.table_row)this.editor_holder=this.container,d(this.editors,function(b,c){var d=a.theme.getTableCell();a.editor_holder.appendChild(d),c.setContainer(d),c.build(),c.postBuild(),a.editors[b].options.hidden&&(d.style.display="none"),a.editors[b].options.input_width&&(d.style.width=a.editors[b].options.input_width)});else{if(this.options.table)
// TODO: table display format
throw"Not supported yet";var b=void 0!==this.jsoneditor.layout_schema;
// add fake container in case we're in layout mode and this object
// is ignored
!this.container&&b&&(this.container=document.createElement("div")),this.header=document.createElement("span"),this.header.textContent=this.getTitle(),this.title=this.theme.getHeader(this.header),b&&this.container.firstChild?this.container.insertBefore(this.title,this.container.firstChild):this.container.appendChild(this.title),this.container.style.position="relative",
// Edit JSON modal
...
this.error_holder=document.createElement("div"),this.container.appendChild(this.error_holder);var f=a.jsoneditor.layout_builder.getGroupForEditor(a);b&&f?"root"==a.key?(this.layout_holder=this.jsoneditor.layout_container,this.editor_holder=this.jsoneditor.layout_container):(this.layout_holder=f.container.editor_holders,this.layout_holder||(this.layout_holder=this.container),this.editor_holder=this.theme.getIndentedPanel(),this.row_container=this.theme.getGridContainer(),this.editor_holder.appendChild(this.row_container),this.layout_holder.appendChild(this.editor_holder)):(this.editor_holder=this.theme.getIndentedPanel(),this.container.appendChild(this.editor_holder),this.row_container=this.theme.getGridContainer(),this.editor_holder.appendChild(this.row_container)),d(this.editors,function(c,d){var e=a.jsoneditor.layout_builder.getGroupForEditor(d);if(b&&!e&&"root"==d.parent.key);else if(b&&e&&e.builder){var f=e.builder.buildEditorHolder(d);e.container.editor_holders.appendChild(f),d.setContainer(f)}else{var g=a.theme.getGridColumn();
// not sure that this is realy required 
a.options.table_row&&(g=a.theme.getTableCell()),a.row_container.appendChild(g),d.setContainer(g)}
// add fake container in case we're in layout mode and this editor
// is ignored
!d.container&&b&&(d.container=document.createElement("div")),d.build(),d.postBuild()}),
// Control buttons
this.title_controls=this.theme.getHeaderButtonHolder(),this.editjson_controls=this.theme.getHeaderButtonHolder(),this.addproperty_controls=this.theme.getHeaderButtonHolder(),this.title.appendChild(this.title_controls),this.title.appendChild(this.editjson_controls),this.title.appendChild(this.addproperty_controls),
// Show/Hide button
this.collapsed=!1,this.toggle_button=this.getButton("","collapse","Collapse"),this.title_controls.appendChild(this.toggle_button),this.toggle_button.addEventListener("click",function(b){b.preventDefault(),b.stopPropagation(),a.collapsed?(a.editor_holder.style.display="",a.collapsed=!1,a.setButtonText(a.toggle_button,"","collapse","Collapse")):(a.editor_holder.style.display="none",a.collapsed=!0,a.setButtonText(a.toggle_button,"","expand","Expand"))}),
...
for(a in this.editors)this.editors.hasOwnProperty(a)&&d++;b=this.canHaveAdditionalProperties()&&!("undefined"!=typeof this.schema.maxProperties&&d>=this.schema.maxProperties),this.addproperty_checkboxes&&(this.addproperty_list.innerHTML=""),this.addproperty_checkboxes={};
...
// Set the active tab
var g=null;d(e.rows,function(a,b){return b.tab===e.active_tab?(g=b.tab,!1):void 0}),!g&&e.rows.length&&(g=e.rows[0].tab),e.active_tab=g,e.refreshValue(b),e.refreshTabs(!0),e.refreshTabs(),e.onChange()}},refreshValue:function(a){var b=this,c=this.value?this.value.length:0;if(this.value=[],d(this.rows,function(a,c){
...
// Make sure value has between minItems and maxItems items in it
if(a=a||[],this.schema.minItems)for(;a.length<this.schema.minItems;)a.push(this.getItemDefault());this.schema.maxItems&&a.length>this.schema.maxItems&&(a=a.slice(0,this.schema.maxItems));var c=JSON.stringify(a);if(c!==this.serialized){var e=!1,f=this;d(a,function(a,b){f.rows[a]?
// TODO: don't set the row's value if it hasn't changed
...
this.oneOf?d(this.editors,function(e,f){if(f){var g=b.path+".oneOf["+e+"]",h=[];d(a,function(a,d){if(d.path.substr(0,g.length)===g){var e=c({},d);e.path=b.path+e.path.substr(g.length),h.push(e)}}),f.showValidationErrors(h)}}):d(this.editors,function(b,c){c&&c.showValidationErrors(a)})}}),
...
if(!c)return function(){return a};for(var d=[],e=function(a){var c,e=b[a].replace(/[{}]+/g,"").trim().split("."),f=e.length;if(f>1){var g;c=function(b){for(g=b,a=0;f>a&&(g=g[e[a]],g);a++);return g}}else e=e[0],c=function(a){return a[e]};d.push({s:b[a],r:c})},f=0;c>f;f++)e(f);
// The compiled function
return function(b){var e,g=a+"";for(f=0;c>f;f++)e=d[f],g=g.replace(e.s,e.r(b));return g}}}},f.defaults.templates.ejs=function(){return window.EJS?{compile:function(a){var b=new window.EJS({text:a});return function(a){return b.render(a)}}}:!1},f.defaults.templates.handlebars=function(){return window.Handlebars},f.defaults.templates.hogan=function(){return window.Hogan?{compile:function(a){var b=window.Hogan.compile(a);return function(a){return b.render(a)}}}:!1},f.defaults.templates.markup=function(){return window.Mark&&window.Mark.up?{compile:function(a){return function(b){return window.Mark.up(a,b)}}}:!1},f.defaults.templates.mustache=function(){return window.Mustache?{compile:function(a){return function(b){return window.Mustache.render(a,b)}}}:!1},f.defaults.templates.swig=function(){return window.swig},f.defaults.templates.underscore=function(){return window._?{compile:function(a){return function(b){return window._.template(a,b)}}}:!1},
...
for(var h in f.defaults.editors)f.defaults.editors.hasOwnProperty(h)&&(f.defaults.editors[h].options=f.defaults.editors.options||{});
// Set the default resolvers
// Use "multiple" as a fall back for everything
f.defaults.resolvers.unshift(function(a){return"string"!=typeof a.type?"multiple":void 0}),
// If the type is not set but properties are defined, we can infer the type is actually object
f.defaults.resolvers.unshift(function(a){return!a.type&&a.properties?"object":void 0}),
...
// Boolean editors
f.defaults.resolvers.unshift(function(a){return"boolean"===a.type?
// If explicitly set to 'checkbox', use that
"checkbox"===a.format||a.options&&a.options.checkbox?"checkbox":f.plugins.selectize.enable?"selectize":"select":void 0}),
// Use the multiple editor for schemas where the `type` is set to "any"
f.defaults.resolvers.unshift(function(a){return"any"===a.type?"multiple":void 0}),
// Editor for base64 encoded files
f.defaults.resolvers.unshift(function(a){return"string"===a.type&&a.media&&"base64"===a.media.binaryEncoding?"base64":void 0}),
// Editor for uploading files
f.defaults.resolvers.unshift(function(a){return"string"===a.type&&"url"===a.format&&a.options&&a.options.upload===!0&&window.FileReader?"upload":void 0}),
// Use the table editor for arrays with the format set to `table`
f.defaults.resolvers.unshift(function(a){return"array"==a.type&&"table"==a.format?"table":void 0}),
// Use the `select` editor for dynamic enumSource enums
f.defaults.resolvers.unshift(function(a){return a.enumSource?f.plugins.selectize.enable?"selectize":"select":void 0}),
...
f.defaults.resolvers.unshift(function(a){return a.oneOf?"multiple":void 0}),
// Autocomplete
f.defaults.resolvers.unshift(function(a){return window.autoComplete&&"string"===a.type&&"autocomplete"===a.format&&a.options?"autocomplete":void 0}),/**
...
// Destroy first
c&&c.destroy(),c=new f(this.get(0),a),this.data("jsoneditor",c),c.on("change",function(){b.trigger("change")}),c.on("ready",function(){b.trigger("ready")}))}return this}}}(),window.JSONEditor=f}();