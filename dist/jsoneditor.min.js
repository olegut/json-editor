...
constructor:f,getLayoutSchemaFor:function(a){return this.layout_schema},init:function(){var a=this;this.ready=!1;var b=f.defaults.themes[this.options.theme||f.defaults.theme];if(!b)throw"Unknown theme "+(this.options.theme||f.defaults.theme);this.schema=this.options.schema,this.layout_schema=this.options.layout_schema,this.theme=new b,this.template=this.options.template,this.refs=this.options.refs||{},this.uuid=0,this.__data={};var c=f.defaults.iconlibs[this.options.iconlib||f.defaults.iconlib];c&&(this.iconlib=new c),this.root_container=this.theme.getContainer(),this.layout_container=this.theme.getContainer(),this.element.appendChild(this.root_container),this.translate=this.options.translate||f.defaults.translate,
...
// TODO: table display format
throw"Not supported yet";this.container||(this.container=document.createElement("div")),this.layout_builder=new f.RootLayoutBuilder({theme:this.theme,layout_schema:this.jsoneditor.getLayoutSchemaFor(this.path),root_container:this.container});var b=void 0!==this.layout_builder.layout_schema;b&&a.layout_builder.buildLayout(),this.header=document.createElement("span"),this.header.textContent=this.getTitle(),this.title=this.theme.getHeader(this.header),b&&this.container.firstChild?this.container.insertBefore(this.title,this.container.firstChild):this.container.appendChild(this.title),this.container.style.position="relative",
// Edit JSON modal
...
this.error_holder=document.createElement("div"),this.container.appendChild(this.error_holder);var g=a.layout_builder.getGroupForEditor(a);b&&g?"root"==a.key?(this.layout_holder=this.jsoneditor.layout_container,this.editor_holder=this.jsoneditor.layout_container):(this.layout_holder=g.container.editor_holders,this.layout_holder||(this.layout_holder=this.container),this.editor_holder=this.theme.getIndentedPanel(),this.row_container=this.theme.getGridContainer(),this.editor_holder.appendChild(this.row_container),this.layout_holder.appendChild(this.editor_holder)):(this.editor_holder=this.theme.getIndentedPanel(),this.container.appendChild(this.editor_holder),this.row_container=this.theme.getGridContainer(),this.editor_holder.appendChild(this.row_container)),d(this.editors,function(c,d){var e=a.layout_builder.getGroupForEditor(d);if(b&&!e&&"root"==d.parent.key);else if(b&&e&&e.builder){var f=e.builder.buildEditorHolder(d);e.container.editor_holders.appendChild(f),d.setContainer(f)}else{var g=a.theme.getGridColumn();
